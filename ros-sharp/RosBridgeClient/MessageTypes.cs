...
namespace RosSharp.RosBridgeClient
{
    ...
    {
        //Add visualization_msgs for Marker
        public static readonly Dictionary<string, Type> Dictionary = new Dictionary<string, Type>
        {
            ...
            { "turtlesim/Pose", typeof(TurtlesimPose)},
            { "rosgraph_msgs/Log", typeof(RosGraphMsgsLog)},
            { "gazebo_msgs/LinkStates", typeof(LinkState)},
            { "gazebo_msgs/ModelStates", typeof(ModelState)},
            { "autoware_msgs/LaneArray", typeof(LaneArray)},
            { "autoware_msgs/waypoint", typeof(waypoint)},
            { "autoware_msgs/WaypointState", typeof(WaypointState)},
            { "autoware_msgs/lane", typeof(lane)},
            { "autoware_msgs/dtlane", typeof(dtlane)}
